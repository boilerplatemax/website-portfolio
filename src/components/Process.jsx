...
export function Process() {
  return (
    <section id="process" className="section border-t border-ink-200">
        ...
        <ol className="mt-14 grid gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
          {PROCESS.map((p, i) => (
            <motion.li
              ...
              className="border-t border-ink-300 pt-5"
            >
              <div className="flex items-baseline justify-between">
                <span className="font-display text-4xl font-medium text-clay-600">
                  {p.step}
                </span>
                <span className="font-mono text-[0.65rem] uppercase tracking-label text-ink-400">
                  Step
                </span>
              </div>
